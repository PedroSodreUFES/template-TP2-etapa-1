...
int main(int argc, char** argv)
{
    ...
    char string[1024], login[21], senha[21], saida[2200], botao, cpf[15], bancodedados[2200];
    char path[2500];
    char nomemedico[51], crmmedico[51];
    nomemedico[0]='\0';
    crmmedico[0]='\0';
    ...
    */
    ...
    scanf("%s%*c", string);
    printf("################################################\n");
    sprintf(bancodedados, "%s/%s", argv[1], string);
    printf("Caminho do banco de dados: %s\n", bancodedados);
    sprintf(saida, "%s/%s", argv[1], "saida");
    printf("Caminho do arquivo saida: %s\n", saida);
    sprintf(path,"%s/%s", bancodedados, "pacientes.bin");
    ...
    */
    while(1)
    {
        ...
        for(i=0 ; i<obtemnmedicos(sade) ; i++)
        {
            ...
            {
                medico=1;
                strcpy(nomemedico, retornanomemedico(m));
                strcpy(crmmedico, retornacrmmedico(m));
                break;
            }
        }
        if(medico==1)
        ...
        else if(opcao==4 && secretariouser==0)
        {
            ...
            while(1)
            {
                ...
                else if(opcao==2)
                {
                    ...
                    tReceita *re = criaReceita(ConsultaNomePaciente(c), tipodeuso, nomedomedicamento, tipodemedicamento, instrucoes, qntd, nomemedico, crmmedico, ConsultaData(c));
                ...
                else if(opcao==3)
                {
                    ...
                    tBiopsia *biopsia = CriaBiopsia(c, cpf, nomemedico, crmmedico);
                ...
                {
                    tEncaminhamento *e = CriaEncaminhamento(c, cpf, nomemedico, crmmedico);
